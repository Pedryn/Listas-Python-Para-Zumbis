...
def numero(x):
    ...
    p20=1
    for d in x:
        soma = soma + ordem.index(d)*p20
        p20=p20*20
    return soma
print (numero("zmbzmb"))

cont = 0
print ('magico do texto A')
for x in txtA:
    if len(set(x)) == len(x) and numero(x) % 42 == 0:
        cont = cont = cont + 1
        print (x)
print(cont)

cont = 0
print ('magico do texto B')
for x in txtB:
    if len(set(x)) == len(x) and numero(x) % 42 == 0:
        cont = cont = cont + 1
        print (x)
